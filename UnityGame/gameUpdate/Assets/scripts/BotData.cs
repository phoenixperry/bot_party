...

{
...

    {
...

        {
            ...
            bot2.GetComponent<botBehavior>().rotateBot(xpos, ypos, zpos);
...

            {
                ...
                bot2.GetComponent<botBehavior>().triggerSound();
                ...
                var colors = bot2.GetComponent<botBehavior>().btn.colors;

                colors.normalColor = Color.blue;

                bot2.GetComponent<botBehavior>().btn.colors = colors;
...

        {
            ...
            bot3.GetComponent<botBehavior>().rotateBot(xpos, ypos, zpos);
...

            {
                ...
                bot3.GetComponent<botBehavior>().triggerSound();
                ...
                var colors = bot3.GetComponent<botBehavior>().btn.colors;

                colors.normalColor = Color.blue;

                bot3.GetComponent<botBehavior>().btn.colors = colors;
