...
bool range = inRange(val, 8,9);
if(range) 
{ 
  Serial.println("box 1 and box 3 connected"); 
}
if(val == 2) Serial.println("box 1 and 2 connected");

//second box reading 
val = map(box2_3, 0, 1024, 0, 5);
smoothData0 = digitalSmooth(val, sensSmoothArray1);
Serial.println(smoothData0); 
range = inRange(smoothData0,8,10); 
if(val == 2) Serial.println("box 2 and 3 connected");
range = inRange(val, 9,10);
